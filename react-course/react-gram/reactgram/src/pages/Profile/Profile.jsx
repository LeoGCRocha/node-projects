...
const Profile = () => {
    ...
    const { user:userRoute } = useSelector(state => state.auth)
        ...
        <div id='profile'>
            ...
            {id === userRoute._id && (
                <>
                    <div className="new-photo" ref={newPhotoForm}>
                        ...
                        {loading && <Message type='error' msg={errorPhoto} />}
                        {error && <Message type='success' msg ={messagePhoto} />}
                    </div>
            ...
            <div className="user-photos">
                ...
                <div className="photos-container">
                    ...
                    {photos.length === 0 && (
                        <p>
                            Ainda não há fotos publicas para este usuário.
                        </p>
                    )}
                </div>
            </div>
